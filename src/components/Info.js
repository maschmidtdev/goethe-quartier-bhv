...
const infoTexts = [
    ...
    ``,
    ``,
    `Ein neues Straßenbild durch Ausbau der Alleen

    Es gibt sehr attraktive Straßen und – leider auch – weniger beliebte Straßen im Goethequartier.
    ...
    Wir möchten jedoch weiter gehen. Fahrradfahrer erhalten eine eigene Spur, mehr Bäume auf beiden Straßenseiten und weitere Nutzungen der Zwischenräume sollen einen attraktiven öffentlichen Verkehrsraum schaffen, der auch Verweilqualität und Begegnungsflächen bietet.
    `,
    `Autofreie Zonen – mehr Qualität für eine lebenswerte Nachbarschaft

    Unsere Annahme, dass eine heterogene, offene und gemeinschaftlich geprägte Nachbarschaft einen großen Beitrag zur Lebensqualität innerhalb eines Stadtquartiers beiträgt, wird durch verschiedene Studien gestützt. So stellt eine Arbeit der Universität Oldenburg beispielsweise klar, dass Nachbarschaftskontakte – wenn auch locker – geschätzt und gesucht werden, sie gehören im besten Falle zum Alltag.
    ...
    Unsere Ideen zu den Straßen Adolfstraße, Uhlandstraße und Lutherstraße (jeweils Abschnitte zwischen Goethestraße und Körnerstraße) zeigen eine gänzlich autofreie Zone, in der Grenzen verschwimmen und der so neu entstehende „Frei“-Raum sich von den Bewohnern zu eigen gemacht werden kann. Gewachsene Barrieren wie Bordsteine und Straßen weichen einem fahrradfreundlichen, entschleunigten Raum, in dem Nachbarschaft ein neues Gesicht bekommen kann. Hier schließen sich Gemeinschaftssinn und individuelle Gestaltung keineswegs aus. Jedoch hängt dieses Konzept stark von der Akzeptanz und auch von der Mitgestaltung der Anwohner ab, wobei die eigene Identifikation mit dem Quartier eine wichtige Rolle spielt.
...
export default function Info({ pictoId, infoId }) {
